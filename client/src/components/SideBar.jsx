...
function SideBar({directMessage, setDirectMessages}) {
     ...
     <aside id="separator-sidebar" class="h-screen transition-transform -translate-x-full sm:translate-x-0 w-full" aria-label="Sidebar">
         <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
               <li>
                  <div class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" onClick={redirectHome}>
               ...
               <li>
                  <div class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"  onClick={addDirectMessage}>
            ...
            {directMessage && directMessage.map((f) => (
               <li> 
                  <DirectMessage id={f.id} name={f.name} username={f.username} setDirectMessages={setDirectMessages} />
               </li>
            ))}
            </ul>
